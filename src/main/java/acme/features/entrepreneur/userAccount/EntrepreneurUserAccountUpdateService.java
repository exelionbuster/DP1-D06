...
package acme.features.entrepreneur.userAccount;
...
@Service
public class EntrepreneurUserAccountUpdateService implements AbstractUpdateService<Entrepreneur, UserAccount> {

	// Internal state ---------------------------------------------------------

	@Autowired
	EntrepreneurUserAccountRepository repository;


	// AbstractUpdateService<Entrepreneur, UserAccount> interface ------------
